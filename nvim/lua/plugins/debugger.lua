...
local setup_dap = function()
  ...
  dap.configurations.cpp = {
    ...
    {
      name = 'Launch ROS test under lldb',
      type = 'lldb',
      request = 'launch',
      program = function()
    ...
    {
      name = "Launch ROS test under gdb",
      type = "gdb",
      request = "launch",
      program = function()
        local bufno = vim.api.nvim_get_current_buf()
  ...
  vim.keymap.set("n", "<leader>ld", function()
    dap.disconnect(); dap.close()
  end, { silent = true, desc = "DAP disconnect" })
  vim.keymap.set("n", "<leader>lk", function()
    dap.terminate(); dap.close()
  ...
  vim.keymap.set("n", "<leader>lB", function() dap.set_breakpoint(vim.fn.input("Breakpoint condition: ")) end,
